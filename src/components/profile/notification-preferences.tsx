...
const notificationOptions: NotificationOption[] = [
  {
    ...
    description: 'Get notified when your account is accessed from a new device or browser',
    ...
    return (
      <Card>
        <CardHeader>
          ...
          <CardDescription>Choose which security notifications you receive</CardDescription>
        </CardHeader>
        <CardContent>
    ...
    <Card>
      ...
      <CardContent className="space-y-4">
        ...
        <p className="text-sm text-gray-500 pt-4">
          These notifications help keep your account secure. We recommend keeping them enabled.
        </p>
      </CardContent>
    </Card>
  )
